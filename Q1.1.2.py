...
mg_and_rest = (labels == 1) | (labels == 3)

features = features[mg_and_rest]
labels = labels[mg_and_rest]
labels[labels == 3] = 0
...
df.to_excel('result/1.1.2/model_info_1.1.2.xlsx')

model.save('models/model_1.1.2.h5')
